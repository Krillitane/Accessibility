...
const christmasCountdown = () => {
    ...
    // Don't calculate time if it is Christmas day
    ...
    // Show remaining minutes. Countdown, 0 hours left, show minutes (00:59)
    if (currentDay == 24 && hours === 0){
        numberData.innerHTML = minutes < 10 ? `0${minutes}` : minutes
        textData.innerHTML = 'Minutes'
    }

    // Show remaining seconds. Countdown, 0 hours & 0 minutes left, show seconds (00:00:59)
    ...
    // Show remaining days and remove Christmas message
